...
const tools: Tool[] = [
  ...
  { icon: "G", name: "유튜브 요약 · Gemini Gems", description: "유튜브 링크를 넣어 머니 유튜브 요약 Gem에서 핵심 내용을 정리", url: "https://gemini.google.com/gem/1CnqDVo6erNyg68H2WflVo1KHjg5Lw1HN?usp=sharing", cta: "Gemini Gems 열기 ↗", group: "AI 투자 루틴", accent: "purple" },
  { icon: "C", name: "유튜브 요약 · ChatGPT", description: "ChatGPT에 유튜브 링크만 보내고 영상의 핵심 내용과 투자 관점을 정리", url: "https://chatgpt.com/", cta: "ChatGPT 열기 ↗", group: "AI 투자 루틴", accent: "purple" },
...
const toolMenuSections = [
  ...
  { label: "📋 정책·자료 분석", items: ["주간 아파트 가격동향 그래프", "주간 아파트 가격동향 분석", "정부정책 분석 (준비중)", "자료 정리 & 인사이트 (준비중)", "유튜브 요약 · Gemini Gems", "유튜브 요약 · ChatGPT"] },
...
const categoryMap = [
  ...
  { icon: "▤", name: "정책·자료 분석", count: "6개", description: "가격보다 먼저 정책과 시장 방향을 읽습니다.", items: ["주간 아파트 가격동향 그래프", "주간 아파트 가격동향 분석", "정부정책 분석", "자료 정리", "유튜브 요약 · Gemini Gems", "유튜브 요약 · ChatGPT"], href: "/research-insights" },
];
