...
const complexes: Complex[] = [
  ...
  { name: "공덕 자이", location: "서울 마포구 · 2013년", price: "23억", change: "+1.2%", school: "학군 보통", transit: "5호선 5분", note: "전용 84㎡ 기준 최근 호가·실거래를 확인", score: 71, area: "전용 84㎡ (약 25평)", mapUrl: "https://map.naver.com/p/search/공덕자이", naverUrl: "https://new.land.naver.com/search?sk=공덕자이" },
