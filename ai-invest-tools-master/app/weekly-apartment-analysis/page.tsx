...
export default function WeeklyApartmentAnalysis() {
  ...
  return <main className="weekly-analysis-page">
    ...
    {data && <>
      <a className="weekly-source-dashboard" href="https://rone-weekly-capital-dashboard.vercel.app/" target="_blank" rel="noreferrer"><div><span>R-ONE WEEKLY GRAPH</span><strong>주간 아파트 가격동향 그래프</strong><p>독립 그래프 페이지에서 전국·수도권·서울·지방 및 전체 구별 자료를 확인하세요.</p></div><b>그래프 열기 ↗</b></a>
