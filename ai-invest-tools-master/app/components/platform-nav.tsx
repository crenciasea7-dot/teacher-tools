...
const toolGroups = [
  ...
  { name: "정책·자료분석", icon: "▤", links: [{ label: "주간 아파트 가격동향 그래프", href: "https://rone-weekly-capital-dashboard.vercel.app/" }, { label: "주간 아파트 가격동향 분석", href: "/weekly-apartment-analysis" }, { label: "자료 정리 & 인사이트", href: "/research-insights" }, { label: "유튜브 영상 요약", href: "https://gemini.google.com/gem/1CnqDVo6erNyg68H2WflVo1KHjg5Lw1HN?usp=sharing" }] },
];
