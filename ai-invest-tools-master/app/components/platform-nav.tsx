...
const toolGroups = [
  { name: "세금", icon: "％", links: [{ label: "보유세 계산기", href: "/property-tax" }, { label: "양도세 · 준비중", href: "" }] },
  ...
  { name: "매수매도", icon: "↗", links: [{ label: "임장동선 · 준비중", href: "" }, { label: "집 잔금 계산기", href: "/jip-jangeum-calculator" }, { label: "집중 아파트 비교", href: "/apartment-research" }, { label: "등기부등본 분석 · 외부", href: "https://realpickai.kr/ai-registry" }] },
