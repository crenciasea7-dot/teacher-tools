...
const toolGroups = [
  ...
  { name: "매수매도", icon: "↗", links: [{ label: "임장동선 · 준비중", href: "" }, { label: "구매력 계산기", href: "https://purchasing-power-calculator.vercel.app/" }, { label: "집중 아파트 비교", href: "https://jipjung-apartment-research.crenciasea7.chatgpt.site/" }, { label: "집 잔금 계산기", href: "/jip-jangeum-calculator" }, { label: "등기부등본 분석 · 외부", href: "https://realpickai.kr/ai-registry" }, { label: "아파트 매도 분석", href: "https://gemini.google.com/gem/14MRd9ZNuQOWNFzkElSMIQs3Hbjy6yaj3?usp=sharing" }] },
  ...
  { name: "정책·자료분석", icon: "▤", links: [{ label: "주간 아파트 가격동향 그래프", href: "https://rone-weekly-capital-dashboard.vercel.app/" }, { label: "주간 아파트 가격동향 분석", href: "/weekly-apartment-analysis" }, { label: "자료 정리 & 인사이트", href: "/research-insights" }, { label: "유튜브 요약 · Gemini Gems", href: "https://gemini.google.com/gem/1CnqDVo6erNyg68H2WflVo1KHjg5Lw1HN?usp=sharing" }, { label: "유튜브 요약 · ChatGPT", href: "https://chatgpt.com/" }] },
];
